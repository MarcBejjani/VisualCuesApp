...
const Home = () => {
    return (
        <div className="home-container">
            ...
            <p>
                This website allows you to interact with different AI models that can generate stories based on your input,
                or suggest different paintings based on a search criteria.
                <br></br>
